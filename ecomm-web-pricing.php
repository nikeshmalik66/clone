...
<section class="heading-pricing">
	<div class="container text-center ">
		<h2>E-Commerce Website Plans</h2>
		<p>Our E-Commerce Website Packages feature all the tools you need to sell your products online. From small businesses to large enterprise, we provide you with turnkey service and solutions, including full access to your very own marketing expert to guide you through it all.</p>


<p>EVERYTHING YOU NEED TO SELL ONLINE:-E-Commerce Website Packages will design and build you a professional, custom e-commerce website tailored to the products and services you want to sell online.This includes a host of powerful tools such as a secure shopping cart with SSL Certificate encryption, visitors tracking,optional Content Management System and Order Tracking features, plus Recurring Billing and Shipping integration etc.</p>
	</div>
</section>
...
<ul class=" mypricing">
	<li class="my-item clr-orange">
		<div class="item-inner">
			<h2 class="item-heading"> Bronze </h2>
			<h1 class="item-price">$149<sup>*</sup></h1>

			<ul class="item-content">
				<li>Custom Website Design</li>
				<li>Logo Design</li>
				<li>Upto 20 Web Pages</li>
				<li>All Device Responsive</li>
				<li>Custom Programming</li>
				<li>Shopping Cart</li>
				<li>Up to 100 Cart Products</li>
				<li>Payment Gateway Integration</li>
				<li>Shipping Integration</li>
				<li>Product Search Engine</li>
				<li>SEO (7 keywords)</li>
				<li>Social Media Setup</li>
				<li>Visitor Tracking</li>
				<li>Up to 20 Emails Accounts</li>
				<li>Website Hosting</li>
			</ul>
			<a href="get-started.php" class=" select-plan">Start</a>
		</div>
	
	</li>
	<li class="my-item clr-green">
		<div class="item-inner">
			<h2 class="item-heading"> Silver </h2>
			<h1 class="item-price">$199<sup>*</sup></h1>

			<ul class="item-content">
				<li>Custom Website Design</li>
				<li>Logo Design</li>
				<li>Upto 30 Web Pages</li>
				<li>All Device Responsive</li>
				<li>Custom Programming</li>
				<li>Shopping Cart</li>
				<li>Up to 300 Cart Products</li>
				<li>Payment Gateway Integration</li>
				<li>Shipping Integration</li>
				<li>Secure Socket Layer (SSL)</li>
				<li>Order Tracking System</li>
				<li>Product Search Engine</li>
				<li>SEO (12 keywords)</li>
				<li>Social Media Setup</li>
				<li>Visitor Tracking</li>
				<li>Live Chat</li>
				<li>Google Map Integration</li>
				<li>Up to 25 Emails Accounts</li>
				<li>Website Hosting</li>
			</ul>
			<a href="get-started.php" class=" select-plan">Start</a>
		</div>
	...
	<li class="my-item clr-yellow">
		<div class="item-inner">
			<h2 class="item-heading"> Gold </h2>
			<h1 class="item-price">$299<sup>*</sup></h1>

			<ul class="item-content">
				<li>Custom Website Design</li>
				<li>Logo Design</li>
				<li>Upto 45 Web Pages</li>
				<li>All Device Responsive</li>
				<li>Custom Programming</li>
				<li>Shopping Cart</li>
				<li>Up to 500 Cart Products</li>
				<li>Payment Gateway Integration</li>
				<li>Shipping Integration</li>
				<li>Secure Socket Layer (SSL)</li>
				<li>Order Tracking System</li>
				<li>Product Search Engine</li>
				<li>SEO (18 keywords)</li>
				<li>Social Media Setup</li>
				<li>Visitor Tracking</li>
				<li>Live Chat</li>
				<li>Google Map Integration</li>
				<li>Print + Design (Biz Card)</li>
				<li>Professional HTML Emailer</li>
				<li>Up to 30 Emails Accounts</li>
				<li>Website Hosting</li>
			</ul>
			<a href="get-started.php" class=" select-plan">Start</a>
		</div>
